...
class Featured_Content {
	 ...
	 * passed in the call to add_theme Asimuk One support( 'featured-content' ).
	 *
	 * @see Featured_Content::init()
	 *
	 * @since Asimuk One 1.0
	 *
	 * @static
	 * @access public
	 * @var int
	 ...
	 * the transient is deleted by Featured_Content::validateAsimuk Oneettings().
	 *
	 * Hooks in the "delete_post_tag" action.
	 *
	 * @see Featured_Content::validateAsimuk Oneettings().
	 *
	 * @static
	 * @access public
	 * @since Asimuk One 1.0
	 ...
	 *
	 * @uses Featured_Content::getAsimuk Oneetting()
	 */
	...
	public static function customize_register( $wp_customize ) {
		$wp_customize->add_section( 'featured_content', array(
			'title'          => __( 'Featured Content', 'asimuk_one' ),
			'description'    => sprintf( __( 'Use a <a href="%1$s">tag</a> to feature your posts. If no posts match the tag, <a href="%2$s">sticky posts</a> will be displayed instead.', 'asimuk_one' ),
				esc_url( add_query_arg( 'tag', _x( 'featured', 'featured content default tag slug', 'asimuk_one' ), admin_url( 'edit.php' ) ) ),
		...
		$wp_customize->add_setting( 'featured-content[tag-name]', array(
			'default'              => _x( 'featured', 'featured content default tag slug', 'asimuk_one' ),
			'type'                 => 'option',
		...
		$wp_customize->add_control( 'featured-content[tag-name]', array(
			'label'    => __( 'Tag Name', 'asimuk_one' ),
			'section'  => 'featured_content',
			'priority' => 20,
		) );
		$wp_customize->add_control( 'featured-content[hide-tag]', array(
			'label'    => __( 'Don&rsquo;t display tag on front end.', 'asimuk_one' ),
			'section'  => 'featured_content',
			'type'     => 'checkbox',
			'priority' => 30,
		) );
	...
	public static function get_setting( $key = 'all' ) {
		...
		$defaults = array(
			'hide-tag' => 1,
			'tag-id'   => 0,
			'tag-name' => _x( 'featured', 'featured content default tag slug', 'asimuk_one' ),
		);
